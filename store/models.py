...
class Order(models.Model):
	...
	total = models.DecimalField(max_digits=10, decimal_places=0, verbose_name='INR Order Total')
...
class OrderItem(models.Model):
	...
	quantity = models.IntegerField()
	price = models.DecimalField(max_digits=10, decimal_places=0, verbose_name='INR Price')
